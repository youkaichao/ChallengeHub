<template>
  <div>
    ...
    <div style="font-size: 20px;">
      <div>
        报名开始时间：
        <span style="font-weight: bold;">{{humanReadableEnrollStart}}</span>
      </div>
      <div>
        报名结束时间：
        <span style="font-weight: bold;">{{humanReadableEnrollEnd}}</span>
      </div>
    ...
    <div style="margin-top: 20px;">
      ...
      <el-button v-else type="primary" @click="handleEnroll">点击此处以组长身份报名</el-button>
    </div>
    ...
    <div v-if="this.contestInfo.enrollUrl === ''">
      ...
      >比赛公告</el-button>
      <el-button type="primary" @click="gotoGroupList">查看已报名的队伍</el-button>
    </div>
