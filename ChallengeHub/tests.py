...
class BackendAPITest(TestCase):
    ...
    def test_procedure(self):
        ...
        for stage in range(1, 3):
            ...
            data = organizer.post(f'/api/contests/{contest_id}/auto_assign',
                                  data={'stage': 2 * stage, "serious": True, "maxconn": 3,
                                        "judges": [{"username": "reviewer1", "assign": 3}]})
            self.assertEqual(data['code'], 0)
            ...
            # 主办方晋级队伍
            data = organizer.post(f'/api/contests/{contest_id}/groups',
                                  data={'stage': 2 * stage + 1, "group_ids": [group_id]})
            self.assertEqual(data['code'], 0)
    ...
    def test_notice(self):
        ...
        # 修改一个公告
        data = organizer.put(f'/api/contests/{contest_id}/notices/{notice_id}',
                             data={"title": "what?", "content": "what?"})
        self.assertEqual(data['code'], 0)
